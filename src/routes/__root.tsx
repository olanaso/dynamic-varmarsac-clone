...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "/logo-pestana.png" },
      { name: "twitter:image", content: "/logo-pestana.png" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", type: "image/png", href: "/logo-pestana.png" },
      { rel: "shortcut icon", type: "image/png", href: "/logo-pestana.png" },
      { rel: "apple-touch-icon", href: "/logo-pestana.png" },
    ],
  }),
